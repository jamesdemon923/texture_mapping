...
Eigen::Vector3f texture_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    Eigen::Vector3f kd = texture_color / 255.f; // Replace kd with texture_color
    ...
    for (auto& light : lights)
    {
        ...
        float r2 = (light.position - point).dot(light.position - point); // a·b/|a||b| = cos<a,b>
...
Eigen::Vector3f phong_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    std::vector<light> lights = {l1, l2}; // light contains position and intensity
    Eigen::Vector3f amb_light_intensity{10, 10, 10};
    Eigen::Vector3f eye_pos{0, 0, 10};
...
Eigen::Vector3f displacement_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    // referring to GAMES101 lecture_10 Page.17 how to perturb the normal(in 3D)
